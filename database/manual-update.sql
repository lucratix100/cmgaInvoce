...
ALTER TABLE invoices ADD CONSTRAINT invoices_status_check CHECK (status IN ('non réceptionnée', 'en attente de livraison', 'en cours de livraison', 'livrée', 'retour', 'régule','annulée'));